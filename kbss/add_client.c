...
void divi(CLIENT *clnt, int a, int b);
void mul(CLIENT *clnt, int a, int b);
...
main(int argc, char *argv[])
{
  ...
  void (*calc[])(CLIENT *clnt, int a, int b) = {add, sub, divi, mul};
